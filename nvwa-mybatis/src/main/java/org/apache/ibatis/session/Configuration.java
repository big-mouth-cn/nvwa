...
public class Configuration {
  ...
  public ResultMap removeResultMap(String id) {
      return this.resultMaps.remove(id);
  }
  ...
  public MappedStatement removeMappedStatement(String id) {
      return this.mappedStatements.remove(id);
  }
