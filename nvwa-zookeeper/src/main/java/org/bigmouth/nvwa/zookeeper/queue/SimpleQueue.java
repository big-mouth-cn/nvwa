...
public class SimpleQueue
{
    ...
    private final String PREFIX = "mq-";

    /**
     * @param client the zkClientHolder
     * @param path path to store queue nodes
     */
    public SimpleQueue(ZkClientHolder zkClientHolder, String path)
    {
        this.zkClientHolder = zkClientHolder;
        this.client = zkClientHolder.get();
        this.path = path;
