 ...
 * under the License.
 */
package org.bigmouth.nvwa.zookeeper.test.addrs;
...
public class AddressReaderTest {
    ...
    public static void main(String[] args) {
        AddressReader reader = new FileAddressReader("C:\\Users\\allen.hu\\zookeeper-address");
        System.out.println(reader.read());
        AddressReader urlreader = new UrlAddressReader("http://172.16.20.43:8081/zkaddrs.html");
